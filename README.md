...
| :--- | :--- | :--- |
| **v1.3.6** | [GIF_Vault_v1.3.6.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.3.6/GIF_Vault_v1.3.6.zip) | Latest release. Preserves popup focus after deleting an item so keyboard flow stays in place, and reduces the vault page size from 18 items to 12. |
