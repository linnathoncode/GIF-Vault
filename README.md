...
| :--------- | :--------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.7.0** | [GIF_Vault_v1.7.0.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.7.0/GIF_Vault_v1.7.0.zip) | Major release with a dedicated Import & Backup page, bulk URL and file import queues, portable vault backup and restore, and a cleaner full-card media layout with overlaid controls. |
| **v1.6.9** | [GIF_Vault_v1.6.9.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.9/GIF_Vault_v1.6.9.zip) | Release with stronger import cancellation during video conversion, faster popup browsing for larger vaults, refined selection/delete UI states, and Chrome Web Store release automation. |
| **v1.6.8** | [GIF_Vault_v1.6.8.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.8/GIF_Vault_v1.6.8.zip) | Release with Instagram context-menu reliability fixes for image-only import gating and stale page-context capture handling across in-app navigation. |
| **v1.6.6** | [GIF_Vault_v1.6.6.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.6/GIF_Vault_v1.6.6.zip) | Legacy release with expanded media URL resolution coverage and polished popup light/dark theme behavior (tabs, selection, hover feedback). |
