...
| :--------- | :--------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.6.8** | [GIF_Vault_v1.6.8.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.8/GIF_Vault_v1.6.8.zip) | Latest release with Instagram context-menu reliability fixes for image-only import gating and stale page-context capture handling across in-app navigation. |
