...
| :--------- | :--------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.6.5** | [GIF_Vault_v1.6.5.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.5/GIF_Vault_v1.6.5.zip) | Latest release with stronger conversion payload safety, including a 64 MB options max-download cap and strict converted-GIF runtime-message size guardrails. |
| **v1.6.4** | [GIF_Vault_v1.6.4.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.4/GIF_Vault_v1.6.4.zip) | Latest release with drag-and-drop import support, improved vertical-video GIF conversion quality, and compact local import action in the popup URL field. |
