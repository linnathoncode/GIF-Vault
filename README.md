...
| :--------- | :--------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.6.4** | [GIF_Vault_v1.6.4.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.4/GIF_Vault_v1.6.4.zip) | Latest release. Compared with `v1.6.2`, this release train adds import-cancel UX/perf improvements (faster terminate propagation with temporary action-button lock), popup coordinator/grid-controller maintenance cleanup (doc comments + centralized timing constants), portrait-video GIF conversion scaling fixes to reduce disproportionate output sizes, drag/drop guard consistency for in-popup drags, compact folder-icon local import action inside the popup URL field, plus follow-up vertical-video quality refinement that avoids upscaling and uses a more compression-friendly palette/dither strategy to reduce artifacts while keeping output size compact. |
