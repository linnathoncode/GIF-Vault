...
| :--------- | :--------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **v1.6.4** | [GIF_Vault_v1.6.4.zip](https://github.com/linnathoncode/GIF-Vault/releases/download/v1.6.4/GIF_Vault_v1.6.4.zip) | Latest release. Compared with the previous version, this release refines vertical-video GIF conversion quality by preventing upscaling beyond source dimensions and using a more compression-friendly palette/dither strategy to reduce artifacts while keeping output size compact. |
